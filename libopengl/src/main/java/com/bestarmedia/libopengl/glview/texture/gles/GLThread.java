...
package com.bestarmedia.libopengl.glview.texture.gles;
...
import com.bestarmedia.libopengl.glview.texture.GLViewRenderer;
import com.bestarmedia.libopengl.util.FileLogger;
...
public class GLThread extends Thread {
    ...
    GLThread(EGLConfigChooser configChooser, EGLContextFactory eglContextFactory, EGLWindowSurfaceFactory eglWindowSurfaceFactory,
             GLViewRenderer renderer, int renderMode, Object surface, EglContextWrapper sharedEglContext) {
        super();
        mWidth = 0;
        mHeight = 0;
        mRequestRender = true;
