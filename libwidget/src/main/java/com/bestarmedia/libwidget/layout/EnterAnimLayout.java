package com.bestarmedia.libwidget.layout;
...
public class EnterAnimLayout extends FrameLayout {
    ...
    public boolean isIsAnimaionRun() {
        return mIsAnimaionRun;
    }

    public void setIsAnimaionRun(boolean isAnimaionRun) {
        this.mIsAnimaionRun = isAnimaionRun;
    }
