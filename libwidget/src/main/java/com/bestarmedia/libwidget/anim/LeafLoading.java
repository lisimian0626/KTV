...
public class LeafLoading extends View {
    ...
    private static final int COLOR_WHITE = 0xffA165FF;      //progress main_bg_v color
    private static final int COLOR_ORANGE = 0xffB07CFF;     //progress color
    ...
    private void initResources(ContextThemeWrapper context) {
        ...
        mDefaultWidth = DensityUtil.dip2px(context, mDefaultWidth);
        mDefaultHeight = DensityUtil.dip2px(context, mDefaultHeight);
    }
    ...
    private void initBitmap() {
        mLeafBitmap = ((BitmapDrawable) mResources.getDrawable(R.drawable.play_game_progress_leaf)).getBitmap();
        mLeafBitmapWidth = mLeafBitmap.getWidth();
        mLeafBitmapHeight = mLeafBitmap.getHeight();

        mOuterBitmap = ((BitmapDrawable) mResources.getDrawable(R.drawable.play_game_progress_oute)).getBitmap();
        mOuterWidth = mOuterBitmap.getWidth();
        mOuterHeight = mOuterBitmap.getHeight();

        mFanBitmap = ((BitmapDrawable) mResources.getDrawable(R.drawable.play_game_progress_fan)).getBitmap();
