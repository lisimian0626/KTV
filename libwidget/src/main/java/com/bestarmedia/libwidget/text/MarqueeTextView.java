...
public class MarqueeTextView extends View implements Runnable {
    ...
    private void initattrs(AttributeSet attrs) {
        TintTypedArray tta = TintTypedArray.obtainStyledAttributes(getContext(), attrs, R.styleable.MarqueeViewText);
        textColor = tta.getColor(R.styleable.MarqueeViewText_marqueeview_text_color, textColor);
        isClickStop = tta.getBoolean(R.styleable.MarqueeViewText_marqueeview_isclickalbe_stop, isClickStop);
        isResetLocation = tta.getBoolean(R.styleable.MarqueeViewText_marqueeview_is_resetLocation, isResetLocation);
        speed = tta.getFloat(R.styleable.MarqueeViewText_marqueeview_text_speed, speed);
        textSize = tta.getFloat(R.styleable.MarqueeViewText_marqueeview_text_size, textSize);
        textDistance1 = tta.getInteger(R.styleable.MarqueeViewText_marqueeview_text_distance, textDistance1);
        startLocationDistance = tta.getFloat(R.styleable.MarqueeViewText_marqueeview_text_startlocationdistance, startLocationDistance);
        repetType = tta.getInt(R.styleable.MarqueeViewText_marqueeview_repet_type, repetType);
        tta.recycle();
    }
