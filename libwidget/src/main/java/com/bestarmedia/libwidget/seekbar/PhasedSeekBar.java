...
public class PhasedSeekBar extends View {
    ...
    protected boolean mUpdateFromPosition = true;
    ...
    protected void init(AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            mItemHalfHeight = (int) (a.getDimension(R.styleable.PhasedSeekBar_phased_item_height, 0.0f) / 2.0f);
...
//        if (mListener != null) {
//            mListener.onPositionSelected(mCurrentItem);
//        }
    }
}
