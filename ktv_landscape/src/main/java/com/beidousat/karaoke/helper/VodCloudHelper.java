...
public class VodCloudHelper {
    ...
    private static void selectMvSong(Context ctx, final MvInfo mvInfo, final boolean is2top, final UserBase userBase) {
    ...
    public static void topSong(Context ctx, final UserBase sender, String songId) {
...
//                }
    ...
    public static void chooseSong(Context ctx, final UserBase sender, String songId) {
