...
public class CornerStyleHelper implements HttpRequestListener {
    ...
    public void onSuccess(String method, Object object) {
        if (RequestMethod.V4.CORNER_STYLE.equalsIgnoreCase(method)) {
            if (object instanceof CornerStylePage) {
                CornerStylePage page = (CornerStylePage) object;
                if (page.corner != null && !page.corner.data.isEmpty()) {
