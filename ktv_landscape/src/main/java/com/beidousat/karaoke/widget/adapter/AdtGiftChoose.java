...
//            if (getSelectCount() >= max) {
//                if (mGiftsChooseListener != null) {
//                    mGiftsChooseListener.onMaxCount(good.count > 0 ? context.getString(R.string.gift_max_select, good.Name, String.valueOf(max))
//                            : context.getString(R.string.gift_count_max_tip, String.valueOf(getMaxCount())));
//                }
//            } else {
//                if (checkMaxCount() && mData.get(position).count < max) {
//                    mData.get(position).count++;
//                    holder.tvCount.setText(String.valueOf(mData.get(position).count));
//                    if (mGiftsChooseListener != null) {
//                        mGiftsChooseListener.onSelectListChanged(getSelGoods(), getMaxCount());
