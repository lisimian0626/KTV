...
public class WidgetUpdateLogPager extends WidgetBasePager {
    ...
    private class SongPagerAdapter extends PagerAdapter {
        ...
        private SparseArray<WidgetUpdateLogPage> sparseArray = new SparseArray<>();
        private int mPageCount;
        private SparseArray<List<SongUpdateLog.SongLog>> mSongs = new SparseArray<>();

        private SongPagerAdapter(Context context, int pages, List<SongUpdateLog.SongLog> logs) {
            mContext = context;
