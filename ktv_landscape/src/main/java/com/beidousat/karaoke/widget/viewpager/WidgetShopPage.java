...
import com.beidousat.karaoke.widget.adapter.AdtShop;
 ...
 */
public class WidgetShopPage extends GridRecyclerView {

    private AdtShop mAdapter;

    public WidgetShopPage(Context context) {
        super(context);
        init();
    }

    public WidgetShopPage(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public WidgetShopPage(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        mAdapter = new AdtShop(getContext());
        setAdapter(mAdapter);
    }
