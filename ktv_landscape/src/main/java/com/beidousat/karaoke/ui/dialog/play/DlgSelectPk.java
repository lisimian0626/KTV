            ...
            public void onFailed(final String method, Object object) {
                ...
                mActivity.runOnUiThread(() -> {
                    ...
                    try {
                        ...
                        PromptDialogSmall promptDialog = new PromptDialogSmall(mActivity);
                        promptDialog.setMessage(getContext().getString(R.string.fire_fail, reason));
                        promptDialog.setOkButton(true, getContext().getString(R.string.ok), v -> dismiss());
                        promptDialog.show();
                    } catch (Exception e) {
