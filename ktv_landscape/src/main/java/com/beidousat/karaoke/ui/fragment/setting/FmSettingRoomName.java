...
public class FmSettingRoomName extends BaseFragment implements View.OnClickListener, KeyboardListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View mRootView = inflater.inflate(R.layout.fm_setting_room, null);
        WidgetKeyboard mWidgetKeyboard = mRootView.findViewById(R.id.keyboard);
    ...
    public void onSuccess(String method, Object object) {
        ...
        PromptDialogSmall dialogSmall = new PromptDialogSmall(getActivity());
        dialogSmall.setTitle(R.string.setting_room_updata_succed);
        dialogSmall.setMessage(R.string.setting_room_updata_name_succed);
        if(getContext()!=null){
            dialogSmall.setOkButton(true, getContext().getString(R.string.ok), view -> EventBusUtil.postSticky(EventBusId.Id.BACK_FRAGMENT, ""));
        }
        dialogSmall.show();
