        ...
        switch (v.getId()) {
            ...
            case R.id.riv_go:
                ...
                if (peopleCount <= 0) {
                    ...
                    dlgGameLuckyText.setOnOkListener(v12 -> dlgGameLuckyText.dismiss());
                ...
                if (mIsStarted) {
                    ...
                    dlgGameLuckyTextStart.setOnOkListener(v13 -> {
                        startGame();
                        if (mPresentation != null) {
                    ...
                    dlgGameLuckyTextStart.setOnNolListener(v14 -> dlgGameLuckyTextStart.dismiss());
                    dlgGameLuckyTextStart.show();
                }
                break;
            case R.id.tv_male:
                DlgGameLuckyCount dlgGameLuckyCount = new DlgGameLuckyCount(getActivity());
                dlgGameLuckyCount.setOnGameLuckNumListener(count -> mTvPeoples.setText(String.valueOf(count)));
