...
public class FmSkin extends BaseFragment {
    ...
    private void init() {
//        mRvSkin.setHasFixedSize(true);
//        ((SimpleItemAnimator) mRvSkin.getItemAnimator()).setSupportsChangeAnimations(false);
//        mRvSkin.setOverScrollMode(View.OVER_SCROLL_NEVER);
        ...
        mRvSkin.setLayoutManager(new GridLayoutManager(getContext(), 2, GridLayoutManager.HORIZONTAL, false));
