...
import com.bestarmedia.libskin.attr.SkinAttrSupport;
import com.bestarmedia.libskin.attr.SkinView;
import com.bestarmedia.libskin.callback.ISkinChangingCallback;
import com.bestarmedia.libskin.utils.L;
import com.bestarmedia.libskin.utils.PrefUtils;
...
public class SkinManager {
    ...
    private boolean validPluginParams(String skinPath, String skinPkgName) {
        ...
        if (info == null || TextUtils.isEmpty(info.packageName) || !info.packageName.equals(skinPkgName))
            return false;
        return true;
    }
    ...
    private void checkPluginParamsThrow(String skinPath, String skinPkgName) {
        if (!validPluginParams(skinPath, skinPkgName)) {
            L.e("skinPluginPath or skinPkgName not valid ! ");
//            throw new IllegalArgumentException("skinPluginPath or skinPkgName not valid ! ");
    ...
    public void changeSkin(final String skinPluginPath, final String skinPluginPkg, final String suffix, ISkinChangingCallback callback) {
        ...
        try {
            ...
            L.e("changeSkin ex:" + e.toString());
            return;
        } catch (Exception e) {
            skinChangingCallback.onError(new RuntimeException("checkPlugin occur Exception error"));
            return;
        }
        ...
        new AsyncTask<Void, Void, Integer>() {
            ...
            protected Integer doInBackground(Void... params) {
                try {
                    ...
                    L.e("AsyncTask doInBackground ex:" + e.toString());
                    return 0;
                }
            }
            ...
            protected void onPostExecute(Integer res) {
                ...
                try {
                    ...
                    L.e("AsyncTask onPostExecute ex:" + e.toString());
    ...
    public void apply(View rootView) {
        List<SkinView> skinViews = SkinAttrSupport.getSkinViews(rootView);
        if (skinViews == null) return;
        for (SkinView skinView : skinViews) {
            skinView.apply();
        }
    ...
    public void register(final View rootView) {
    ...
    public void unregister(View rootView) {
