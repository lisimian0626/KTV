...
public class CoolScreenHelper implements HttpRequestListener {
    ...
    public void onSuccess(String method, Object object) {
        CoolScreen page;
        if (RequestMethod.V4.COOL_SCREEN.equalsIgnoreCase(method) && object instanceof CoolScreen
                && (page = (CoolScreen) object) != null && page.hyunList != null && !page.hyunList.data.isEmpty()) {
