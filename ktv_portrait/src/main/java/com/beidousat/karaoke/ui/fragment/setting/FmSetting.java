...
public class FmSetting extends BaseFragment implements View.OnClickListener, View.OnLongClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mRootView.findViewById(R.id.tv_ktv_room).setOnClickListener(this);
    ...
    private void toCalibrationActivity() {
        try {
            ...
            Logger.w(FmSetting.class.getSimpleName(), "open Calibration ex:" + e.toString());
        }
    }
