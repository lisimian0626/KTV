                ...
                if (nodeRoom == null) {
                    ...
                    if (isReplace()) {
                        ...
                        if (selectDeviceType.type == 1) {
                            ...
                            promptDialogBig.setOkButton(true, "替换", view13 -> regist(getMainID()));
                            ...
                            promptDialogBig.setOkButton(true, getString(R.string.setting_room_dlg_replace_title, selectDeviceType.name), view1 -> {
