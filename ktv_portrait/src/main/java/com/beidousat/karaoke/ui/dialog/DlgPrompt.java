...
public class DlgPrompt extends BaseDialog implements OnClickListener {

    private final String TAG = DlgPrompt.class.getSimpleName();
...
//    private Activity outerActivity;
    ...
    public DlgPrompt(Activity context) {
