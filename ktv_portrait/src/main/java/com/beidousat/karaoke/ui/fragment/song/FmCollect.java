...
//        LinearLayoutManager layoutManager2 = new LinearLayoutManager(getActivity().getApplicationContext());
...
//        request.addParam("per_page", String.valueOf(14));
...
//        DlgRoomQrCode dialog = new DlgRoomQrCode(getContext());
//        dialog.show();
//    }
//
//    @Override
