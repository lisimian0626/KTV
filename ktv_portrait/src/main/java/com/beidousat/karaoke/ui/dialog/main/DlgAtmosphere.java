...
//        }
    ...
    private void loadSoFromLandscape() {
        Context context;
        try {
            context = getContext().createPackageContext("com.beidousat.karaoke", Context.CONTEXT_IGNORE_SECURITY | Context.CONTEXT_INCLUDE_CODE);
    ...
    private void initView() {
        ...
        mFlHandwriting = findViewById(R.id.tablet);
