...
public class WidgetUpdateLogPage extends RecyclerView {
    ...
    private static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView tvDate, tvUpdateLog;
    ...
    public class AdtLog extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            viewHolder.tvDate = (TextView) itemView.findViewById(R.id.tv_date);
            viewHolder.tvUpdateLog = (TextView) itemView.findViewById(R.id.tv_content);
            return viewHolder;
        }
