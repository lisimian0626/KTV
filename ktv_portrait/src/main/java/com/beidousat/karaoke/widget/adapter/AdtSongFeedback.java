...
public class AdtSongFeedback extends BaseAdapter {
    ...
    public void setFocus(int ps, int which) {
        mFocusPs = ps;
        mFocusWhich = which;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.mEtSongName = (TextView) convertView.findViewById(R.id.et_song_name);
            holder.mEtSinger = (TextView) convertView.findViewById(R.id.et_singer);
            holder.mEtBug = (TextView) convertView.findViewById(R.id.et_bug);
        ...
        holder.mEtSongName.setOnClickListener(new View.OnClickListener() {
            @Override
...
//        });
        ...
        holder.mEtSinger.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                setFocus(position, 1);
                notifyDataSetChanged();
    ...
    private static class ViewHolder {
        public TextView mEtSongName, mEtSinger, mEtBug;
    }
}
