...
public class WidgetConsumePager extends WidgetBasePager {
    ...
    private class SongPagerAdapter extends PagerAdapter {
        ...
        private SparseArray<WidgetConsumePage> sparseArray = new SparseArray<WidgetConsumePage>();
        private int mPageCount;
        private SparseArray<List<Consume>> mSongs = new SparseArray<List<Consume>>();

        public SongPagerAdapter(Context context, int pages, List<Consume> consumes) {
            mContext = context;
