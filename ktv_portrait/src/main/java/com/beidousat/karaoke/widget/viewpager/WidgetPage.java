...
public class WidgetPage extends RelativeLayout implements View.OnClickListener {
    ...
    private void init() {
        ...
        tvPrePage = mRootView.findViewById(R.id.tv_pre);
        tvNextPage = mRootView.findViewById(R.id.tv_next);
        tvPagesNum = mRootView.findViewById(R.id.tv_pages);
        tvFirstPage = mRootView.findViewById(R.id.tv_first);
