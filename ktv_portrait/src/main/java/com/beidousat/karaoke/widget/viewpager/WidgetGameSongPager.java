...
public class WidgetGameSongPager extends WidgetBasePager {
    ...
    public void initPager(int totalPage, List<SongSimple> firstPageSongs, Map<String, String> requestParams) {
        mIndexPage = new HashMap<Integer, List<SongSimple>>();
    ...
    private class SongPagerAdapter extends PagerAdapter {
        ...
        private SparseArray<WidgetGameSong> sparseArray = new SparseArray<WidgetGameSong>();
        private int mPageCount;
        private SparseArray<List<SongSimple>> mSongs = new SparseArray<List<SongSimple>>();
        ...
        public SongPagerAdapter(Context context, List<SongSimple> songs) {
            mContext = context;
