...
public class DataEncodeThread extends Thread implements AudioRecord.OnRecordPositionUpdateListener {
     ...
     * @param bufferSize
     */
    public DataEncodeThread(RingBuffer ringBuffer, String savePath, int bufferSize) {
        try {
            this.os = new FileOutputStream(savePath);
...
//		UtilLog.d("processData Read size: " + bytes);
        if (bytes > 0) {
